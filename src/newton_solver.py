...
class NewtonSolver:
    ...
    def __init__(self, model_state_class, solverinfo, resume, rewind):
        ...
        self._def_stats_vars(solver_state=self._solver_state)
    ...
    @action_step_log_wrap(step="NewtonSolver._def_stats_vars", per_iteration=False)
    # pylint: disable=unused-argument
    def _def_stats_vars(self, solver_state):
        """
